...
function renderTodos(todos) {
  ...
  todos.forEach(function (item) {
    ...
    li.setAttribute("class", "item flex items-center");
    ...
    li.innerHTML = `
      ...
      <button
              type="button"
              class="delete-button text-white bg-gradient-to-br from-purple-600 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-blue-300 dark:focus:ring-purple-800 font-medium rounded-full text-sm px-4 py-2.5 text-center ml-auto"
            >
              X
            </button>
    `;
